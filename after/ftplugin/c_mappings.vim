...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Originally taken from https://github.com/norman/vim-files/blob/master/plugin/cscope.vim
"
...
if has("cscope")
    ...
    " split new window on the right instead of the left
    set splitright

    " split new window below the current window
    set splitbelow
    ...
    " thing, but does a horizontal split instead (vim 6 only).
    "
